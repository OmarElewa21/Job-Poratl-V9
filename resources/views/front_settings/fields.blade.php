<div class="row">
    <div class="form-group col-md-3 col-sm-12">
        ...
        <label class="custom-switch pl-0 col-12">
            <input type="checkbox" name="featured_jobs_enable" class="custom-switch-input featured-job-active"
    ...
    <div class="form-group col-xl-3 col-md-3 col-sm-12">
        {{ Form::label('currency', __('messages.front_settings.featured_listing_currency').':') }}<span
                class="text-danger">*</span>
        {{ Form::select('currency', $currencies, (isset($frontSettings['currency']) && $frontSettings['currency'])?$frontSettings['currency']:null ,['id'=>'currency','class' => 'form-control','placeholder' => 'Select Currency','required']) }}
    </div>
    <div class="form-group col-md-3 col-sm-12">
    ...
    <div class="form-group col-xl-3 col-md-3 col-sm-12">
        ...
        <label class="custom-switch pl-0 col-12">
            <input type="checkbox" name="featured_companies_enable" class="custom-switch-input featured-company-active"
    ...
    <div class="form-group col-xl-3 col-md-3 col-sm-12">
        ...
        <label class="custom-switch pl-0 col-12">
            <input type="checkbox" name="latest_jobs_enable" class="custom-switch-input job-country-active"
