            ...
            <div class="slot-box-inner mb-3">
                ...
                @foreach($jobSchedule as $key => $value)
                    <div
                        ...
                        <input type="hidden"
                               class="{{$value->status == \App\Models\JobApplicationSchedule::STATUS_REJECTED ? 'slot-box-danger' : ''}}{{$value->status == \App\Models\JobApplicationSchedule::STATUS_SEND ? 'slot-success' : ''}}"
                               value="{{$value->id}}">
                        <div class="row p-3">
