            ...
            {{Form::open(['id' => 'skillSelectionForm'])}}
                <div class="d-flex justify-content-between mb-2">
                    <div>
                        ...
                        {{ sizeof($skills) == sizeof($defaultSkillsIdsList) ? 'checked' : ''}}>
                        <label class="ml-2 font-weight-bold">Select all</label>
                    </div>
                    
                    <div>
                        <label> Sort </label>
                        <select id="sortingSelect" name="sortingVal">
                            <option value="random">Random</option>
                            <option value="heighest">From heighest to lowest</option>
                            <option value="lowest">From lowest to heighest</option>
                        </select>
                    </div>
                </div>
            ...
            <div id="skillListContainer">
                @foreach ($data as $item)
                    @php
                        ...
                        $notNullCategories = [];
                    @endphp
                <div class="mt-3 shadow bg-white rounded pr-3 pl-3 pt-5 pb-5 skillCard">
                    ...
                    @else
                        ...
                        <div class="w-75" style="margin: auto">
                            ...
                            <div class="progress" style="height: 25px;" aria-valuenow="{{$totalScore}}">
...
<script>
    if(typeof skillCards == null){
        let skillCards = document.querySelectorAll(".skillCard");
    }else{  
        skillCards = document.querySelectorAll(".skillCard");
    }
