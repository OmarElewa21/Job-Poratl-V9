...
$(document).on('click', '.delete-btn', function (event) {
  ...
  swal({
    ...
    text: Lang.get('messages.common.are_you_sure_want_to_delete') + '"' + Lang.get('messages.company.employer') + '" ?',
    type: 'warning',
...
document.addEventListener('delete', function () {
  swal({
    ...
    text: Lang.get('messages.company.employer') + Lang.get('messages.common.has_been_deleted'),
    type: 'success',
    confirmButtonColor: '#6777ef',
    timer: 2000
  });
